...
namespace IIS.Rpavy
{
    ...
    public class МестоНаРейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Rpavy.КлассБилета fКласс;
        ...
        public virtual IIS.Rpavy.КлассБилета Класс
        {
            get
            {
                ...
                IIS.Rpavy.КлассБилета result = this.fКласс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсE", typeof(IIS.Rpavy.МестоНаРейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсL", typeof(IIS.Rpavy.МестоНаРейс));
                }
            }
        }
    }
