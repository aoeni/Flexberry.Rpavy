...
namespace IIS.Rpavy
{
    ...
    public class Рейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Rpavy.DetailArrayOfИнфБронь fИнфБронь;
        ...
        public virtual IIS.Rpavy.DetailArrayOfИнфБронь ИнфБронь
        {
            get
            {
                ...
                {
                    this.fИнфБронь = new IIS.Rpavy.DetailArrayOfИнфБронь(this);
                }
                IIS.Rpavy.DetailArrayOfИнфБронь result = this.fИнфБронь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсE", typeof(IIS.Rpavy.Рейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсL", typeof(IIS.Rpavy.Рейс));
                }
            }
        }
    }
