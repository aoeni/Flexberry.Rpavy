...
namespace IIS.Rpavy
{
    ...
    public class ИнфБронь : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Rpavy.Рейс.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИнфБроньE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИнфБроньE", typeof(IIS.Rpavy.ИнфБронь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИнфБронь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Rpavy.DetailArrayOfИнфБронь members)

        // *** End programmer edit section *** (IIS.Rpavy.DetailArrayOfИнфБронь members)
        ...
        /// </summary>
        public DetailArrayOfИнфБронь(IIS.Rpavy.Рейс fРейс) : 
                base(typeof(ИнфБронь), ((ICSSoft.STORMNET.DataObject)(fРейс)))
        {
        }
        
        public IIS.Rpavy.ИнфБронь this[int index]
        {
            get
            {
                return ((IIS.Rpavy.ИнфБронь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Rpavy.ИнфБронь dataobject)
        {
